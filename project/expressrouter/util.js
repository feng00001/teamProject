...
var BMP24 = require('../../util/BMP24');//gd-bmp
...
function makeCapcha() {
    ...
    img.drawCircle(rand(0, 100), rand(0, 40), rand(10 , 40), rand(0, 0x66ccff));
    //边框
    img.drawRect(0, 0, img.w-1, img.h-1, rand(0, 0xffffff));
    img.fillRect(rand(0, 100), rand(0, 40), rand(10, 35), rand(10, 35), rand(0, 0xffffff));
    img.drawLine(rand(0, 100), rand(0, 40), rand(0, 100), rand(0, 40), rand(0, 0x66ccff));
    //return img;
